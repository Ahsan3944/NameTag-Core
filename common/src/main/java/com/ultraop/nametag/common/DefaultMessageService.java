...
public final class DefaultMessageService implements MessageService {
    ...
    private static Map<String, String> defaultMessages() {
        ...
        defaults.put("message.usage", "/nametag create <tag> <displayName> | list | give <player> <tag> | set <player> <tag> | remove <player> | clear <player> | delete <tag> | reload | glitch <tag> <white|colorful> | effect <tag> <none|rainbow|pulse|wave> | role <tag> <permission|clear>");
        return defaults;
    }
}
